...
export const metadata: Metadata = {
  metadataBase: new URL("https://programari.joydetailing.ro"),
  title: "Programează Acum la Joy Detailing – Detailing Auto Profesional",
  description:
  ...
  openGraph: {
    ...
    url: "https://programari.joydetailing.ro/",
    siteName: "Joy Detailing",
    type: "website",
    locale: "ro_RO",
    images: [
      {
        url: "https://programari.joydetailing.ro/whatsapp.jpg",
        width: 1200,
        height: 935,
